...
public class CustomersJobs {
    ...
    public void setJobresource(String jobresource) {
        this.jobresource = jobresource == null ? null : jobresource.trim();
    }
    ...
    public void setOpsteam(String opsteam) {
        this.opsteam = opsteam == null ? null : opsteam.trim();
    }
    ...
    public String getHardkpi() {
        return hardkpi;
    }

    public void setHardkpi(String hardkpi) {
        this.hardkpi = hardkpi == null ? null : hardkpi.trim();
    }
